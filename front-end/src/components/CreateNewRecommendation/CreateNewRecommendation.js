...
export default function CreateNewRecommendation({ onCreateNewRecommendation = () => 0, disabled = false }) {
  ...
  return (
    <Container>
      ...
      <Input type="link" placeholder="https://youtu.be/..." value={link} onChange={e => setLink(e.target.value)} disabled={disabled} />
      <Button className="btn" onClick={() => handleCreateRecommendation()} disabled={disabled}>
